...
public class App extends Activity implements CvCameraViewListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        camera.SetCaptureFormat(Videoio.CV_CAP_MODE_RGB);
...
//            camera.startRecord();
            ...
            ((MyJavaCameraView) camera).startRecord();
...
//            camera.stopRecord();
            ...
            ((MyJavaCameraView) camera).stopRecord();
        }
    }
    ...
    public void onCameraFrame(Canvas canvas) {
        ...
        if (face != null) {
            ...
            // draw no face box
            noFaceRect = new Rect(0, 0, canvas.getWidth(), canvas.getHeight());
