...
public abstract class MyCameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private VideoWriter mVideoWritter;
    private boolean m_bRecording;
    private String m_strRecPath;
...
//                    break;
        ...
        private int mPreviewFormat = Videoio.CAP_MODE_RGB;
    ...
    protected void deliverAndDrawFrame(MyCameraBridgeViewBase.CvCameraViewFrame frame) {
        ...
        //write video;
//        if(m_bRecording){
//            boolean bOpen1 = false, bOpen2 = false;
//            // Log.d(TAG, "filepath : " + filepath);
//            if (mVideoWritter == null) {
//                mVideoWritter = new VideoWriter(m_strRecPath, VideoWriter.fourcc('M', 'J', 'P', 'G'), 25.0D, modified.size());
//                Log.d(TAG,"Pinky good : " + mVideoWritter);
//                bOpen1 = mVideoWritter.open(m_strRecPath, VideoWriter.fourcc('M', 'J', 'P', 'G'), 25.0D, modified.size());
//                Log.i(TAG, "Pinky: recordFilePath" + m_strRecPath);
//            }
//            if (!mVideoWritter.isOpened()) {
//                Log.w(TAG, "Pinky: open");
//                bOpen2 = mVideoWritter.open(m_strRecPath, VideoWriter.fourcc('M', 'J', 'P', 'G'), 25.0D, modified.size());
//            }
//            mVideoWritter.write(modified);
//
//            Log.e("Pinky", "mat Size;" + modified.size());
//        } else {
//            if (mVideoWritter != null) {
//                mVideoWritter.release();
...
//        }
    ...
    private String recordfilepath() {
        ...
        File vrdir = new File(sddir, "PULSE_VIDEO");
